<?php
/* Smarty version 3.1.29, created on 2016-06-08 23:46:20
  from "E:\tangdengshuai\Apache24\htdocs\myweb\ylmf\application\back\view\question\question_list.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_57583dcc421591_92778055',
  'file_dependency' => 
  array (
    'c6df8c5d2017f57397fb58058818c521ea472deb' => 
    array (
      0 => 'E:\\tangdengshuai\\Apache24\\htdocs\\myweb\\ylmf\\application\\back\\view\\question\\question_list.html',
      1 => 1465400762,
      2 => 'file',
    ),
  ),
...
function content_57583dcc421591_92778055 ($_smarty_tpl) {
$_smarty_tpl->ext->_inheritance->init($_smarty_tpl, true);
?>

<?php 
$_smarty_tpl->ext->_inheritance->processBlock($_smarty_tpl, 0, "content", array (
  0 => 'block_2906057583dcc3812e6_76692851',
  1 => false,
  3 => 0,
  2 => 0,
));
...
/* {block 'content'}  file:question/question_list.html */
function block_2906057583dcc3812e6_76692851($_smarty_tpl, $_blockParentStack) {
?>
        ...
        <div class="mod-head">
            <h3>
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#list">问题列表</a></li>
        ...
        <div class="mod-body tab-content">
            <div id="list" class="tab-pane active">
                ...
                <form method="post" action="" id="batchs_form">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                            <tr>
                                <td><div class="icheckbox_square-blue" style="position: relative;"><input type="checkbox" value="12" name="question_ids[]" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;"></ins></div></td>
                                <td><a target="_blank" href="http://localhost/wecenter/?/question/12">论代码的重要性</a></td>
                                <td>0</td>
                                <td>1</td>
                                <td><a target="_blank" href="http://localhost/wecenter/?/people/kang">kang</a></td>
                                <td>5 小时前</td>
                                <td>5 小时前</td>
                                <td><a title="" class="icon icon-edit md-tip" target="_blank" href="http://localhost/wecenter/?/publish/12" data-original-title="编辑"></a></td>
                            </tr>
                            <tr>
                                <td><div class="icheckbox_square-blue" style="position: relative;"><input type="checkbox" value="11" name="question_ids[]" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;"></ins></div></td>
                                <td><a target="_blank" href="http://localhost/wecenter/?/question/11">孔子是哪国人？</a></td>
                                <td>0</td>
                                <td>1</td>
                                <td><a target="_blank" href="http://localhost/wecenter/?/people/kang">kang</a></td>
                                <td>22 小时前</td>
                                <td>22 小时前</td>
                                <td><a title="" class="icon icon-edit md-tip" target="_blank" href="http://localhost/wecenter/?/publish/11" data-original-title="编辑"></a></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="mod-table-foot">
                    ...
                    <a onclick="$('#action').val('remove'); AWS.ajax_post($('#batchs_form'));" class="btn btn-danger">删除</a>
                </div>
            </div>

            <div id="search" class="tab-pane">
                <form role="form" class="form-horizontal" id="search_form" onsubmit="return false;" action="http://localhost/wecenter/?/admin/question/question_list/" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 col-xs-9">
                            <div class="row">
                                <div class="col-xs-11  col-sm-5 mod-double">
                                    <input type="text" value="" name="answer_count_min" class="form-control">
                                </div>
                                    <span class="mod-symbol col-xs-1 col-sm-1">
                                    -
                                    </span>
                                <div class="col-xs-11 col-sm-5">
                                    <input type="text" value="" name="answer_count_max" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5 col-xs-8">
                            <div class="checkbox mod-padding">
                                <label><div class="icheckbox_square-blue" style="position: relative;"><input type="checkbox" name="best_answer" value="1" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;"></ins></div> 有最佳回复</label>
                            </div>
                        </div>
                    </div>
